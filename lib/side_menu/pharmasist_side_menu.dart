...
import 'package:medi_finder_user_home_page/pharmacy_interface/pharmasist_pages/pharmasist_home_page.dart';
import 'package:medi_finder_user_home_page/pharmacy_interface/pharmasist_pages/pharmasist_profile_page.dart';
        ...
        children: [
          UserAccountsDrawerHeader(
            ...
            currentAccountPicture: CircleAvatar(
              child: ClipOval(
                child: Image.asset("assets/logo/img1.jpeg"),
              ),
            ),
          ...
          GestureDetector(
            onTap: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => PharmacistProfilePage()),
              );
            },
            child: ListTile(
